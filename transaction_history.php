...
<nav id="navbar">
        ...
        <li class="item"><a href="index.php">Home</a></li>
            ...
            <!-- <li class="item"><a href="#">Order Your Items</a></li> -->
        </ul>
    </nav>
    <section id="home">
        <h1 class="primary">View Your Transaction History</h1>
        <p>The Spark Bank</p>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : white; font-family: 'Dancing Script', cursive">Transaction History</h2>
