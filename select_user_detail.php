    ...
    else if($amount > $sql1['balance']) 
    {
        ...
        echo '</script>';
         ...
         echo "</script>";
                ...
                if($query){
                     echo "<script> alert('TRANSACTION PROCESS COMPLETED SUCCESSFULLY');
...
<nav id="navbar">
        ...
        <li class="item"><a href="index.php">Home</a></li>
            ...
            <li class="item"><a href="select_user_detail.php">Transfer Money</a></li>
            <li class="item"><a href="transaction_history.php">Transaction History</a></li>
           
        </ul>
    </nav>
    <section id="home">
        <h1 class="primary">Transaction</h1>
        <p>The Spark Bank</p>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : white; font-family: 'Dancing Script', cursive">Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
